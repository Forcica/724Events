...
const Select = ({
   ...
   const changeValue = (newValue) => {
      setValue(newValue); // Ajout de "newValue" à la "setValue" comme ca L'état collapsed est maintenant mis à true pour fermer la liste déroulante après sélection d'une nouvelle valeur. onChange reçoit newValue pour signaler le changement de valeur.
      setCollapsed(true);
      onChange(newValue);
   };
   return (
